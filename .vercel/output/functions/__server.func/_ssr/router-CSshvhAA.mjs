...
//#region node_modules/.nitro/vite/services/ssr/assets/router-CSshvhAA.js
...
var Route$30 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				property: "og:title",
				content: "Controle de ASOs"
			},
			{
				property: "og:description",
				content: "Gerencie ASOs, exames ocupacionais, comparecimento, pendências e indicadores em um só lugar."
			},
			{
				property: "og:type",
				content: "website"
...
var Route$24 = createFileRoute("/api/login")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		if (!await verifyPassword(password, user.password_hash)) return Response.json({
			ok: false,
			error: "Usuário ou senha inválidos"
		}, { status: 401 });
...
var $$splitComponentImporter$10 = () => import("./relatorios-DXi80xGY.mjs");
var Route$18 = createFileRoute("/_authenticated/relatorios")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./pendencias-wviW_-y5.mjs");
...
var $$splitComponentImporter$5 = () => import("./exames-CLMoiDmS.mjs");
...
var Route$6 = createFileRoute("/api/exames/enviar-confirmacao")({ server: { handlers: { POST: async ({ request }) => {
	try {
		...
		const { createTransporter } = await import("./email-smtp-BaZnqfv3.mjs");
	...
	try {
		...
		try {
			...
			if (unseenUids.length === 0) {
				debug.allUidsCount = (await client.search({ uid: true })).length;
				return {
					success: true,
					emails: [],
					debug
...
var $$splitComponentImporter = () => import("../_id-C2Gf_Mkm.mjs");
